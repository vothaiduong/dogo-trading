...
function dogo_job_seeds() {
	return apply_filters( 'dogo_job_seeds', array(
		...
		array(
			...
			'posted' => '2026-05-03',
			'salary' => array(
				'ja' => '月給 ¥250,000〜¥280,000（経験・スキルにより決定／試用期間 3 か月あり）',
				'en' => '¥250,000–¥280,000 / month (set by experience · 3-month probation)',
				'vi' => '¥250.000–¥280.000/tháng (theo kinh nghiệm · thử việc 3 tháng)',
			),
			'department' => array( 'ja' => '管理部門 ／ 事務', 'en' => 'Administration', 'vi' => 'Hành chính' ),
			'location' => array( 'ja' => '福岡本社', 'en' => 'Fukuoka HQ', 'vi' => 'Trụ sở Fukuoka' ),
			'type' => array( 'ja' => '正社員', 'en' => 'Full-time', 'vi' => 'Toàn thời gian' ),
			'level' => array( 'ja' => '事務経験者歓迎（未経験応相談）', 'en' => 'Office experience welcome', 'vi' => 'Ưu tiên có kinh nghiệm văn phòng' ),
			'title' => array(
				'ja' => '一般事務スタッフ（オフィスアシスタント）',
				'en' => 'Office Assistant — General Administration',
				'vi' => 'Nhân viên Hành chính Văn phòng',
			),
			'intro' => array(
				'ja' => '株式会社 DOGO では、事業拡大に伴い社内の事務業務をサポートしていただける方を募集しています。当社は海外向け EC 事業を行う会社です。書類整理、データ入力、メール・電話対応など日常的な事務業務を中心にお任せします。難しい専門知識よりも、丁寧に仕事を進められる方、基本的なビジネスマナーのある方、長く安定して働ける方を歓迎します。※日本国籍の方、または永住・定住の在留資格をお持ちの方を対象としています。',
				'en' => 'As Dogo Corporation grows, we are looking for someone to support our in-house administrative work. We run a cross-border eCommerce business, and this role centers on everyday office tasks — document handling, data entry, email and phone support. More than specialist knowledge, we value careful work, solid business manners, and a wish to grow with us long term. Open to Japanese nationals and holders of Permanent Resident or Long-Term Resident status.',
				'vi' => 'Cùng với sự phát triển của Dogo Corporation, chúng tôi tìm người hỗ trợ công việc hành chính nội bộ. Chúng tôi vận hành thương mại điện tử xuyên biên giới; vị trí này tập trung vào công việc văn phòng hằng ngày — xử lý giấy tờ, nhập liệu, hỗ trợ email và điện thoại. Hơn cả kiến thức chuyên môn, chúng tôi coi trọng sự cẩn thận, tác phong chuẩn mực và mong muốn gắn bó lâu dài. Tuyển người Nhật, hoặc người có tư cách lưu trú Vĩnh trú (永住) / Định trú (定住).',
			),
			'responsibilities' => array(
				...
				'en' => array(
					...
					'Phone support',
					'Checking and dispatching mail and parcels',
					'Organizing invoices, receipts and related documents',
					'Assisting with internal document preparation',
					'Helping prepare various application forms',
					'Supporting management with administrative tasks',
					'Other general office duties',
				),
				'vi' => array(
					'Sắp xếp và lưu trữ giấy tờ',
					'Nhập liệu',
					'Xử lý email',
					'Trực điện thoại',
					'Kiểm tra và gửi thư / bưu kiện',
					'Sắp xếp hóa đơn, biên lai và chứng từ liên quan',
					'Hỗ trợ soạn tài liệu nội bộ',
					'Hỗ trợ chuẩn bị các loại đơn từ',
					'Hỗ trợ công việc hành chính cho ban giám đốc',
					'Các công việc văn phòng chung khác',
				),
			),
			'requirements' => array(
				'ja' => array(
					'日本国籍の方、または永住・定住の在留資格をお持ちの方',
					'日本語でのビジネスメール対応ができる方',
					'基本的な PC 操作ができる方',
					'Excel・Google スプレッドシートの基本操作ができる方',
					'責任感を持って仕事に取り組める方',
					'基本的なビジネスマナーがある方',
				),
				'en' => array(
					'Japanese national, or holder of Permanent Resident / Long-Term Resident status',
					'Able to handle business email in Japanese',
					'Basic PC skills',
					'Basic Excel / Google Sheets',
					'A responsible approach to work',
					'Solid business manners',
				),
				'vi' => array(
					'Người Nhật, hoặc có tư cách lưu trú Vĩnh trú (永住) / Định trú (定住)',
					'Xử lý được email công việc bằng tiếng Nhật',
					'Sử dụng máy tính cơ bản',
					'Thao tác cơ bản Excel / Google Sheets',
			...
			'nice' => array(
				...
				'en' => array(
					'Experience in general, sales, or administrative office work',
					'Experience handling a wide range of office duties at an SME',
					'Interest in eCommerce',
					'Able to commit long term',
				),
				'vi' => array(
					'Kinh nghiệm hành chính / hành chính kinh doanh / tổng vụ',
					'Từng đảm nhiệm nhiều mảng văn phòng tại doanh nghiệp vừa và nhỏ',
					'Quan tâm đến lĩnh vực eCommerce',
			...
			'ideal' => array(
				'ja' => array(
					...
					'報告・連絡・相談がきちんとできる方',
					'細かい確認作業が苦にならない方',
					'社内外の人と落ち着いてコミュニケーションが取れる方',
					'柔軟に業務へ対応できる方',
				),
				'en' => array(
					'Steady, careful and detail-oriented',
					'Communicates well — reports, shares and consults',
					'Comfortable with meticulous checking',
					'A calm communicator with people inside and outside the company',
					'Flexible and adaptable',
				),
				'vi' => array(
					'Làm việc cẩn thận, tỉ mỉ, đều đặn',
					'Báo cáo – liên lạc – trao đổi (hô-ren-sô) rõ ràng',
					'Không ngại công việc kiểm tra chi tiết',
					'Giao tiếp điềm tĩnh với người trong và ngoài công ty',
					'Linh hoạt thích ứng với công việc',
				),
			),
			'benefits' => array(
				'ja' => array(
				...
				'en' => array(
					'Hours 9:00–18:00 (1-hour break)',
					'Two full days off per week (Sat & Sun)',
					'Year-end / New-Year holidays · paid leave',
					'Full social insurance · employment insurance',
					'Salary raises · casual dress code',
				),
				'vi' => array(
					'Giờ làm 9:00–18:00 (nghỉ trưa 60 phút)',
					'Nghỉ trọn 2 ngày/tuần (Thứ 7 & CN)',
					'Nghỉ Tết dương lịch · nghỉ phép có lương',
					'Bảo hiểm xã hội đầy đủ · bảo hiểm thất nghiệp',
					'Có tăng lương · trang phục tự do',
				),
			),
		),
